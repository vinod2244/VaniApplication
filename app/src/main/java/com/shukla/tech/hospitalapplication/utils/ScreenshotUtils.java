...
public class ScreenshotUtils {
    ...
    public static File getMainDirectoryName(Context context) {
        ...
        File mainDir = new File(Environment.getExternalStorageDirectory() + "/Receipts");
...
//
//        File direct = new File(Environment.getExternalStorageDirectory() + "/Receipts");
//
//        if (!direct.exists()) {
//            File wallpaperDirectory = new File("/sdcard/Receipts/");
//            wallpaperDirectory.mkdirs();
//        }
//
//        File file = new File("/sdcard/Receipts/", fileName);
//        if (file.exists()) {
//            file.delete();
//        }
//        try {
